    ...
    <div className="model-manager-tab-content">
      ...
      {loading ? (
        ...
        <div className="empty-state">
          <span>No trained origin models found.</span>
          <span className="hint">Train a model using the YOLO Training dialog (Origin tab).</span>
        </div>
      ) : (
...
export default OriginModelsTab;
