...
import { Play, Square, Loader2, AlertCircle, CheckCircle, FolderOpen, Download, FileImage, Cpu, Monitor, Zap, RotateCcw } from 'lucide-react';
...
export function DetectionTab() {
  ...
  }, [datasetSource, datasetPath, projectHasEnoughData, projectStats, images, follicles]);
